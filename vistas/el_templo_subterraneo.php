...
<body>
	...
	<div class="about-me container">
            ...
            Miré una y otra vez por la abertura. Allí se veía un camino ascendente y arenoso. No era visible el cielo ni la hierba, pero para mí era suficiente para continuar. Ya sabía cuándo era de día y de noche. Y cuando la noche llegó decidí dormir y descansar. Y antes del amanecer seguí rompiendo la puerta. 
                ...
                <p>
            Permanecí contra la pared por horas, jadeante, hasta que de repente me pareció escuchar voces. Al principio fueron difusas, pero después fueron claras y parecieron acercarse. Entonces intenté gritar, pero la garganta no me respondió. Era como si mis cuerdas bocales estuvieran dormidas a causa del desuso. Al principio simplemente hice un mugido, pero al ver que las voces se alejaban, tomé de nuevo aire y, desesperado, grité con todas mis fuerzas: -¡Auxilio! ¡Ayuda por favor!
            <br>Entonces las voces se callaron por un momento.
            <br>-¡Ayuda! -volví a gritar.
            <br>Entonces vi que dos personas se acercaban. Era turistas igual que yo.
            <br>-¿Qué sucede? -preguntó uno de ellos con acento.
            <br>-¡Por favor ayúdenme! Los de la aldea me encerraron acá. 
            <br>Uno de los turistas me miró y dijo: -Debe ser la persona desaparecida que está buscando la policía.
            <br>-Vamos a avisarle a las autoridades -dijo el otro.
            <br>Pero yo negué con la cabeza. -¡Por favor, no me dejen solo! -les rogué desesperado. Estoy seguro que la caverna apestaba, y yo también, pues ellos hacían muecas cada vez que se acercaban al hueco de la puerta desde donde yo les hablaba.
            <br>Entonces uno de ellos asintió y decidió quedarse. El otro turista se fue a buscar a los rescatistas. Y mientras esperábamos le conté todo mi sufrimiento al extraño. Iván, como se llamaba, estaba conmocionado con la historia, y miraba a todos lados, temeroso de que los aldeanos vinieran y también lo encerraran conmigo. Pero primero llegaron Julio (el otro turista) con dos policías locales.
                </p>
                <p>
	...
	<br></br>
        <a href="javascript:history.back(-1);" title="Ir la página anterior">Volver</a> | <a href="la_pesadilla.php#body" title="La Pesadilla">Leer La Pesadilla</a>
        <div class="counts">
            <div class="row">
