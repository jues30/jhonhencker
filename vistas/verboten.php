...
<body>
	...
	<div class="about-me container">
            ...
            <br>-¡No dispare! No somos fantasmas ni nada. Sólo estábamos cansados -grité con el alemán más fluido que hablé alguna vez.
            <br>Entonces Karl se levantó e, igual que yo, levantó las manos. -Tranquilo -le dijo al guardia en alemán.
            <br>El guardia de la catacumba ya tenía la mano en el cinto cuando yo grité, listo para tomar el arma. Yo sólo había visto una sombra negra tras la lámpara, pero al ver la reacción supe de inmediato que tenía la intención de disparar. Pero al escucharnos, el guardia se calmó. -¿Qué hacen acá? -preguntó.
            <br>-Vinimos con el grupo de Hans para recorrer las catacumbas -dijo Karl.
            <br>Pero el guardia parecía confundido. -¿Hoy? -preguntó-. ¿Y a esta hora?
            <br>-Si- respondió Karl -. El grupo debe estar en el último nivel. Somos siete. Deben estar por llegar -añadió.
            <br>Pero el guardia meneó la cabeza. -Esta catacumba está cerrada desde hace décadas. Está prohibida la entrada.
            <br>Entonces Karl y yo nos miramos, asombrados.
            <br>-Además, no hay nadie abajo. Vengo de hacer todo el recorrido. Sólo están ustedes dos…
                </p>
                <p>
	...
	<br></br>
        <a href="javascript:history.back(-1);" title="Ir la página anterior">Volver</a> | <a href="el_templo_subterraneo.php#body" title="El Templo Subterráneo">Leer El Templo Subterráneo</a>
        <div class="counts">
            <div class="row">
