...
<body>
	...
	<br></br>
        <a href="javascript:history.back(-1);" title="Ir la página anterior">Volver</a> | <a href="la_dama_arrogante.php#body" title="La Dama Arrogante">Leer La Dama Arrogante</a>
        <div class="counts">
            <div class="row">
